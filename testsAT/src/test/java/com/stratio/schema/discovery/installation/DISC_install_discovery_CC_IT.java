...
@CucumberOptions(features = { "src/test/resources/features/001_installation/002_disc_installDiscoveryCC.feature" }, plugin = "json:target/cucumber.json")
public class DISC_install_discovery_CC_IT extends BaseTest {
    ...
    @Test(enabled = true, groups = {"install_discovery_cc"}, dataProvider = "scenarios")
